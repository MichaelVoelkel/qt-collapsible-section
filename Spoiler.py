...
if __name__ == '__main__':
    class Window(wd.QMainWindow):
        def __init__(self, parent=None):
            super().__init__(parent)
            section = Spoiler("Spoiler", 100, self)
    
            anyLayout = wd.QVBoxLayout()
            anyLayout.addWidget(wd.QLabel("Some Text in Spoiler", section))
            anyLayout.addWidget(wd.QPushButton("Button in Spoiler", section))
